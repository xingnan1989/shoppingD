...
public class FavoritsDelete extends HttpServlet {

	/**
	 * Constructor of the object.
	 */
	public FavoritsDelete() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		idd.deleteFavorits(goodsID);
		request.getRequestDispatcher("FavoritsSelectManager").forward(request, response);
		out.close();
	}
