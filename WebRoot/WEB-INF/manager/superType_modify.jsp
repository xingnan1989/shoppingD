					...
					<table width="777" height="288" border="0" align="center"
						...
						<tr>
							...
							<td align="center" valign="top">
								...
								<!-- 不同的部分中间的部分 -->
									<form action="UpdateSuperType?superTypeCode=${type.typeCode }" method="post" name="form1">
									    <table width="100%"  border="0" align="center" cellpadding="-2" cellspacing="-2" bordercolordark="#FFFFFF">
						                  <tr>
						                    <td height="30">大分类名称：</td>
											<td><input name="typename" type="text" id="typename" size="40" value="${type.typeName }" onblur="checkTypeName()"></td>
						                  </tr> 
						                  <tr>
						                    <td height="30">类型编号：</td>
											<td><input name="typeCode" type="text" id="typeCode" size="60" value="${type.typeCode }" onblur="updateSelectSuperCode()"><span id="span"></span></td>
						                  </tr> 
										  <tr>
						                    <td width="16%" >描&nbsp;&nbsp;&nbsp;&nbsp;述</td>
						                    <td width="84%" ><textarea cols="50" rows="5" name="description" onblur="checkDescription()">${type.typeDesc }</textarea></td>
						                  </tr>
						                  <tr align="center">
						                    <td height="30" colspan="3">
						                        <input type="submit" class="btn_grey" value="保存" onclick="return succeed()">
						                        &nbsp;                        
